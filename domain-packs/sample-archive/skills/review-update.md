---
name: sample-archive-review-update-adapter
...
# Sample Archive Review Update Adapter
...
- No-op review update records the checked window and archive question.
- Activity-only records do not change public claim maturity.
- Evidence-update bundles require `source_fidelity`, `scope_fit`, and `context_boundaries` appraisal lanes.
