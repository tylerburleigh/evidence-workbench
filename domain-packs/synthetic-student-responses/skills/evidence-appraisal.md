...
- `applicability_boundary`: verify assessment purpose, decision consequence, and operational use, especially when a claim moves from low-stakes or developmental evidence to high-stakes validation language.
