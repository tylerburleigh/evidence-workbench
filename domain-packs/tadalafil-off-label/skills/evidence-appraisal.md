...
- `exposure_directness`: verify tadalafil dose, timing, duration, daily versus as-needed use, and any transfer from other PDE5 inhibitors.
...
- `synthesis_overreach`: block claims that imply off-label medical advice, treat mechanism as clinical benefit, overgeneralize from indirect populations, or detach benefit from safety.
...
- `blocking` is true for unresolved source mismatch, missing serious safety boundary, unsupported population transfer, endpoint mismatch, or overbroad benefit claim.
