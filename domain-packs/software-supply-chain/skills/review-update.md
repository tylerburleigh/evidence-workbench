---
name: software-supply-chain-review-update-adapter
...
# Software Supply Chain Review Update Adapter
...
- No-op review update records the checked window and control.
- Activity-only records do not upgrade the claim stage.
- Evidence-update bundles require all default appraisal lanes.
