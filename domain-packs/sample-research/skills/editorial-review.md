---
name: sample-research-editorial-review-adapter
...
# Sample Research Editorial Review Adapter
...
- The target bundle, staged files, review comments, and evidence reviews.
...
- If optional `limitations` or `taxonomy_mapping` reviews were requested, treat them as required for that revision.

## Output Checks

- Approve only when bundle validation and evidence-review gates are ready.
