...
Lit Review Studio is a domain-configurable framework for agent-assisted research.
...
Build a file-backed research studio for domains where claims must be traceable, reviewable, and updateable.
...
- [workflows.md](workflows.md): Baseline Review, Review Update, evidence appraisal, publish, planning sync, and report-integration workflows
...
- Evidence appraisals are structured records, not prose-only comments.
...
- `domain-packs/`: domain taxonomy, extraction fields, appraisal lanes, public copy, and skill adapters
...
- `data/evidence-appraisals`: structured verification passes
...
- `scripts/appraise-evidence.mjs`: evidence-appraisal scaffold and apply flow
