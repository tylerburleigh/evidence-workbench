...
const collectionPaths = {
  ...
  evidenceAppraisals: "data/evidence-appraisals",
  editorialComments: "data/editorial-comments",
...
export async function loadDomainStudioData(options = {}) {
  ...
  const evidenceAppraisals = collections.evidenceAppraisals.filter(({ record }) => bundleIds.has(record.candidate_bundle_id));
  const editorialComments = collections.editorialComments.filter(({ record }) => bundleIds.has(record.candidate_bundle_id));
