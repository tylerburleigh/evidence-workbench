...
description: Use when producing a cross-record synthesis report for one domain or bounded set of taxonomy scope units after baseline or surveillance records have been published.
---
...
- Published records under `data/claims`, `data/findings`, `data/sources`, `data/evidence-reviews`, and `data/publication-events`.
...
3. Inventory published claims, supporting findings, sources, evidence reviews, publication events, applicability facets, and planning status for the scope.
...
- Do not upgrade targeted bootstrap evidence into systematic-review language.
...
- Clear next actions that point to bootstrap, surveillance, evidence-review, or editorial-review workflows when new public records are needed.
