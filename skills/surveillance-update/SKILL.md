---
name: surveillance-update
description: Use when checking an already scoped research unit for material changes since the latest review, publication, or surveillance pass.
---
...
- `domain-packs/<domain-id>/skills/surveillance.md`
...
5. For staged changes, create or update a candidate bundle with `intake_mode: "surveillance_update"` when the schema supports it, or a clearly named update bundle when it does not.
6. Run validation:
